...
class UserTracker
{
    ...
    */
    ...
    private function searchArray($array, $needle)
    {
    ...
    */
    ...
    public function getUserBrowser()
    {
        ...
        return $this->searchArray($this->browsers, $userAgent);
    }
    ...
    */
    ...
    {
        $userAgent = request()->header('User-Agent') ?? 'no_data';
        return $this->searchArray($this->operatingSystems, $userAgent);
    }
    ...
    */
    ...
    {
        $userAgent = request()->header('User-Agent') ?? 'no_data';
        return $this->searchArray($this->devices, $userAgent);
    }
    ...
    */
    ...
    public function getUserLanguage()
    {
        ...
        return $this->searchArray($this->languages, $userLang);
    }
}
